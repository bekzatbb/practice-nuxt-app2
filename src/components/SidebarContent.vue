<template>
	<SidebarSection>
      <ul>
        ...
        <SidebarNavItem label="Shorts" icon="fire" />
    ...
    <SidebarSection class="px-8 py-4 font-medium leading-5 border-b">
      ...
      <LoginButton class="focus:outline-none flex items-center px-2 py-0.5 mt-3 text-sm text-blue-700 uppercase border border-blue-700 rounded-sm" />
    </SidebarSection>
    <SidebarSection>
